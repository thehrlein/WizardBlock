...
class NavigationFragment : BaseFragment<BaseNavigationViewModel, FragmentNavigationBinding>() {

    override val viewModel: BaseNavigationViewModel by activityViewModel()
