...
import com.tobiashehrlein.tobiswizardblock.feature.gamesettings.databinding.ItemPlayerRowBinding
...
class PlayerOrderViewHolder(private val binding: ItemPlayerRowBinding) :
    ...
    fun bind(
        ...
        binding.playerPosition.text =
            binding.root.context.getString(com.tobiashehrlein.tobiswizardblock.feature.common.R.string.player_order_position, absoluteAdapterPosition + 1)
