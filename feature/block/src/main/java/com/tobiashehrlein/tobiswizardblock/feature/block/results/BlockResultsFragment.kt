...
import com.tobiashehrlein.tobiswizardblock.feature.block.databinding.FragmentBlockResultsBinding
import com.tobiashehrlein.tobiswizardblock.feature.block.widgets.BlockNameView
import com.tobiashehrlein.tobiswizardblock.feature.block.widgets.BlockPlaceHolderView
...
import com.tobiashehrlein.tobiswizardblock.feature.common.utils.ItemDecoration
                ...
                addItemDecoration(
                    ItemDecoration(
                        ...
                        AppCompatResources.getDrawable(
                            context,
                            com.tobiashehrlein.tobiswizardblock.feature.common.R.drawable.wb_shape_divider
                        )
                    )
                )
                addItemDecoration(
        ...
        menu.findItem(R.id.action_delete_input).apply {
            ...
            title = getString(
                if (viewModel.inputType.value == InputType.RESULT) {
                    com.tobiashehrlein.tobiswizardblock.feature.common.R.string.game_block_results_menu_delete_last_bet_input
                } else {
                    com.tobiashehrlein.tobiswizardblock.feature.common.R.string.game_block_results_menu_delete_last_result_input
                }
            )
        }
