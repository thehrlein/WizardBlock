package com.tobiashehrlein.tobiswizardblock.feature.block.input.correcttips
...
import com.tobiashehrlein.tobiswizardblock.feature.block.databinding.DialogBlockInputCorrectTipsChoosePlayerBinding
import com.tobiashehrlein.tobiswizardblock.feature.common.ui.dialog.BaseDialogFragment
...
class BlockInputCorrectTipsChoosePlayerDialog :
    ...
    override fun onBindingCreated() {
        ...
        dialogEntity.playerTipData.forEach { data ->
            val radio = RadioButton(requireContext()).apply {
                ...
                text = getString(
                    com.tobiashehrlein.tobiswizardblock.feature.common.R.string.block_input_correct_bets_choose_player_name_and_bet,
                    data.playerName,
                    data.tip
                )
                setTextAppearance(
                    com.tobiashehrlein.tobiswizardblock.feature.common.R.style.TextAppearance_WizardBlock_Body1
                )
                val padding = context.getDimen(com.tobiashehrlein.tobiswizardblock.feature.common.R.dimen.space_2)
                setPadding(padding, padding, padding, padding)
                val params = RadioGroup.LayoutParams(
                    RadioGroup.LayoutParams.MATCH_PARENT,
                    RadioGroup.LayoutParams.WRAP_CONTENT
                )
                val margin = context.getDimen(com.tobiashehrlein.tobiswizardblock.feature.common.R.dimen.space_1)
    ...
    private fun setUpCountLayout(dialog: AlertDialog) {
        ...
        dialog.setTitle(
            getString(
                com.tobiashehrlein.tobiswizardblock.feature.common.R.string.block_input_correct_bets_count_title,
