...
import com.tobiashehrlein.tobiswizardblock.feature.block.databinding.FragmentBlockInputBinding
...
import com.tobiashehrlein.tobiswizardblock.feature.common.utils.extensions.getNameRes
import com.tobiashehrlein.tobiswizardblock.feature.common.utils.extensions.isLandscape
    ...
    override fun onBindingCreated(savedInstanceState: Bundle?) {
        ...
        activityToolbarViewModel.setTitle(
            getString(
                when (navArgs.inputType) {
                    InputType.TIPP -> com.tobiashehrlein.tobiswizardblock.feature.common.R.string.block_input_toolbar_title_bets
                    InputType.RESULT -> com.tobiashehrlein.tobiswizardblock.feature.common.R.string.block_input_toolbar_title_results
                }
            )
        )
        ...
        viewModel.playerTipDataCorrectedEvent.observe(viewLifecycleOwner) {
            Snackbar.make(
                ...
                getString(
                    com.tobiashehrlein.tobiswizardblock.feature.common.R.string.block_input_correct_bets_snackbar_message,
                    it.playerName,
                    it.tip
                ),
