...
class PlayerCountStatisticsView @JvmOverloads constructor(
    ...
    fun setPlayerCountStatistics(playerCount: Map<Int, Int>?) {
        if (playerCount.isNullOrEmpty()) {
            ...
            binding.statisticsPlayerCountChartLabelXAxis.isVisible = false
            binding.statisticsPlayerCountChartLabelYAxis.isVisible = false
        } else {
            binding.statisticsPlayerCountChartLabelXAxis.isVisible = true
            binding.statisticsPlayerCountChartLabelYAxis.isVisible = true
            binding.statisticsPlayerCountChart.apply {
